...
export function WeeklyProblem() {
  ...
  if (loading) {
    return (
      <div className="flex h-64 items-center justify-center rounded-xl border border-white/[0.07] bg-[#0d1109]/85">
  ...
  if (!problem) {
    return (
      <div className="rounded-xl border border-white/[0.07] bg-[#0d1109]/85 p-8 text-center text-sm text-white/50">
  ...
  return (
    <div className="rounded-2xl border border-white/[0.08] bg-[#0d1109]/92 overflow-hidden shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_20px_60px_-20px_rgba(0,0,0,0.8)]">
      <div className="p-6 md:p-7">
        ...
        <div className="mt-6 pt-4 border-t border-white/[0.06] flex justify-end">
          <Link
            href={href}
            className="font-code group inline-flex items-center gap-2 rounded-lg border border-amber-400/30 bg-amber-500/15 hover:bg-amber-500/25 px-5 py-2.5 text-sm font-semibold text-amber-200 transition-all hover:scale-[1.02] active:scale-95 no-underline"
          >
