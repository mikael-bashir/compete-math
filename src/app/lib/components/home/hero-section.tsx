  ...
  return (
    ...
    <section className="pt-[4.5rem] pb-2 text-center">
      ...
      <div className="mx-auto mt-10 max-w-md">
        <div className="relative rounded-2xl border border-white/[0.08] bg-[#0d1109]/92 px-8 py-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.07),0_20px_60px_-20px_rgba(0,0,0,0.8)]">
