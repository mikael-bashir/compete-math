...
export function Leaderboard() {
  ...
  return (
    <div className="relative flex flex-col h-full rounded-2xl border border-white/[0.08] bg-[#0d1109]/92 shadow-[inset_0_1px_0_rgba(255,255,255,0.07),0_20px_60px_-20px_rgba(0,0,0,0.8)]">
