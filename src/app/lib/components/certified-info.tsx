  ...
  return (
    ...
    >
      ...
      {open && (
        <div
          role="tooltip"
          className={`absolute top-6 z-50 w-72 rounded-xl border border-amber-400/20 bg-[#0d1109] p-4 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.9)] normal-case tracking-normal ${
