...
const Home = () => {
  return (
    <div className="large-text-container mx-auto p-6 space-y-6 font-sans">
      <h1 className="text-4xl font-semibold text-center text-black mt-[60px]">
      ...
      <h4 className="text-2xl font-medium text-gray-800">
        Compete Math:{' '}
        <a href="mailto:bashir.mikael@outlook.com" className="text-blue-500 hover:underline">
