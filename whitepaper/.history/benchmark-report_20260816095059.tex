...
increase rapidly, which raises the natural question "Do the same techniques for ATP on LLMs apply on Agentic systems, and to what extent". 
The Leak stack is an agentic theorem-proving system for Lean~4 + Mathlib
\cite{demoura2021lean4,mathlib2020} that tries to answer exactly this, built around remote verification services
