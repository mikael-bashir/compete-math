...
testing if this still holds in large agentic systems such as Claude, which already have 
...
\begin{enumerate}[itemsep=1pt]
  \item \textbf{Absolute proving capacity.} What fraction of an algebra
        ...
        can Leak close under fixed time budgets?
  \item \textbf{Adding scaffolding vs.\ Relying on built-in scaffolding.} Does the augmented architecture
