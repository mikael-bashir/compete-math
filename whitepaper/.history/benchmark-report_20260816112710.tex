...
\noindent
The reason we have two families of services is because of toolchain differences between some of the libraries involved (pantograph and lean architect).
...
All services follow the MCP protocol on SSE transport \cite{anthropic2024mcp}.
