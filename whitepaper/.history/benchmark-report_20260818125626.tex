...
\begin{description}[itemsep=2pt]
  ...
  \item[Ultra (Lifted Goedel Architect).] An inspired pipeline driven by a local
        ...
        of proved lemmas between two seperate proof attempts and was not given NL proofs to shape decomposition. This
        is the only reported run armed with Leak XI, Leak XII, and Leak XIV. 
  \item[Control~II (compiler + lemma search).] Same driving agent as Ultra, armed with Leak IV and Leak I
  ...
  \item[Control III (blind prover).] Same driving agent as Ultra, given \emph{no} additional Leak tools:
        ...
        Leak~IV gate decides correctness. Benchmarked as \run{control-oneshot-3}. This
        run was designed to test the core agent's proving capability, and get an absolute baseline.
  \item[Control IV (compiler + pantograph + lemma search).] Same driving agent as Ultra armed with
        Leak I, Leak II, and Leak IV, again leaving all orchestration to Claude's built-in harness \cite{anthropicharness}.
        This run was specifically designed to see if a pantograph service improves *overall* proving capacity (more theorems proven).
\end{description}
...
\subsection{Per-problem economy on shared solves}

On the 26 problems \emph{both} arms prove we can compare their resource use
head-to-head, item by item (Fig.~\ref{fig:paired}). The two are broadly
comparable per problem: neither arm is systematically cheaper, faster, or more
frugal with calls. What stands out are a few spikes where Control~II pays
heavily for a problem Ultra dispatches cheaply --- \run{fatex\_069} and
\run{fatex\_083} cost it \$13--14 and 30--40\,min at 290--333 LLM calls, versus
Ultra's ${<}\$3$ and ${<}10$\,min --- and the mirror cases where Ultra pays more
(\run{fatex\_040}, \run{fatex\_084}). The lesson: the aggregate cost/time gap of
Table~\ref{tab:headtohead} is \emph{not} a per-problem efficiency difference on
shared work; it comes from the extra (harder) problems each arm uniquely solves
and from budget burned on misses (\S\ref{sec:cost}).

\begin{figure}[H]
\centering
\begin{tikzpicture}
\begin{groupplot}[
  group style={group size=2 by 2, horizontal sep=1.7cm, vertical sep=1.4cm,
    x descriptions at=edge bottom},
  width=0.47\linewidth, height=4.4cm, xmin=0, xmax=86,
  xlabel={FATE-X problem index}, ymin=0,
  tick label style={font=\scriptsize}, label style={font=\footnotesize},
  title style={font=\footnotesize},
  every axis plot/.append style={thin, mark size=1.4pt, mark options={solid}}]
\nextgroupplot[ylabel={Notional cost (\$)}, title={Cost}, legend style={font=\scriptsize, at={(0.03,0.97)}, anchor=north west, draw=none, fill=none}]
\addplot[blue!55!black, mark=square*] coordinates {(1,2.84) (2,0.36) (3,4.86) (4,7.12) (5,3.93) (7,1.24) (8,4.61) (14,1.53) (15,1.64) (21,5.11) (22,2.53) (29,2.88) (30,1.29) (35,0.11) (36,11.46) (40,3.33) (46,1.26) (48,3.51) (49,1.75) (52,1.42) (54,0.78) (57,4.64) (69,13.66) (70,0.85) (83,10.13) (84,2.71)};
\addlegendentry{Control~II}
\addplot[red!70!black, mark=*, densely dashed] coordinates {(1,1.67) (2,0.46) (3,6.24) (4,6.86) (5,2.57) (7,0.43) (8,7.40) (14,1.46) (15,1.40) (21,5.50) (22,3.57) (29,2.22) (30,1.08) (35,0.08) (36,6.69) (40,7.80) (46,0.83) (48,1.84) (49,1.41) (52,1.40) (54,0.97) (57,3.86) (69,0.52) (70,0.33) (83,2.68) (84,5.71)};
\addlegendentry{Ultra Fleeting}
\nextgroupplot[ylabel={Time to prove (min)}, title={Wall time}]
\addplot[blue!55!black, mark=square*] coordinates {(1,17.56) (2,4.33) (3,25.23) (4,29.71) (5,21.62) (7,5.25) (8,20.61) (14,10.48) (15,10.16) (21,23.55) (22,16.52) (29,14.03) (30,6.38) (35,0.36) (36,45.10) (40,17.61) (46,5.95) (48,18.31) (49,11.32) (52,10.12) (54,5.39) (57,24.46) (69,40.68) (70,4.85) (83,30.18) (84,15.30)};
\addplot[red!70!black, mark=*, densely dashed] coordinates {(1,7.55) (2,2.95) (3,21.21) (4,33.45) (5,10.41) (7,2.56) (8,26.66) (14,8.79) (15,10.28) (21,25.54) (22,18.93) (29,8.45) (30,6.18) (35,0.70) (36,31.96) (40,36.68) (46,7.33) (48,11.28) (49,4.88) (52,6.25) (54,5.87) (57,26.74) (69,3.40) (70,1.39) (83,9.37) (84,31.05)};
\nextgroupplot[ylabel={LLM calls}, title={LLM calls}]
\addplot[blue!55!black, mark=square*] coordinates {(1,54) (2,11) (3,97) (4,150) (5,120) (7,57) (8,131) (14,18) (15,29) (21,151) (22,99) (29,102) (30,62) (35,9) (36,233) (40,104) (46,64) (48,83) (49,21) (52,24) (54,11) (57,95) (69,333) (70,23) (83,290) (84,64)};
\addplot[red!70!black, mark=*, densely dashed] coordinates {(1,70) (2,19) (3,251) (4,282) (5,149) (7,30) (8,355) (14,57) (15,23) (21,212) (22,171) (29,125) (30,61) (35,6) (36,198) (40,310) (46,58) (48,106) (49,66) (52,80) (54,48) (57,105) (69,44) (70,23) (83,145) (84,185)};
\nextgroupplot[ylabel={Tool calls}, title={Tool calls}]
\addplot[blue!55!black, mark=square*] coordinates {(1,24) (2,5) (3,50) (4,79) (5,63) (7,30) (8,69) (14,8) (15,14) (21,82) (22,54) (29,52) (30,32) (35,5) (36,130) (40,53) (46,35) (48,42) (49,11) (52,13) (54,6) (57,51) (69,178) (70,14) (83,158) (84,33)};
\addplot[red!70!black, mark=*, densely dashed] coordinates {(1,46) (2,11) (3,161) (4,169) (5,101) (7,19) (8,226) (14,36) (15,14) (21,136) (22,105) (29,84) (30,42) (35,4) (36,126) (40,208) (46,39) (48,66) (49,40) (52,52) (54,30) (57,73) (69,32) (70,15) (83,102) (84,118)};
\end{groupplot}
\end{tikzpicture}
\caption{Per-problem economy on the 26 problems both arms prove, against
problem index: notional cost, wall-clock solve time, LLM calls, and tool calls.
Ultra Fleeting (dashed) tends to finish the easy shared items faster via
parallel node-filling; Control~II (solid) occasionally pays a large premium on a
few (\run{fatex\_069}, \run{fatex\_083}). No arm dominates the shared set.}
\label{fig:paired}
\end{figure}

A sharper reading of Fig.~\ref{fig:paired} cuts against FATE-X's headline
framing. The benchmark is \emph{ordered by increasing difficulty}, yet among the
problems that were actually \emph{solved}, none of the four cost measures trends
upward with problem index: a solved item near rank~84 costs about what a solved
item near rank~4 does. Difficulty, as FATE-X orders it, does \emph{not} show up
as a solved problem being more expensive to prove.

Where the ordering \emph{does} hold is the \emph{rate} of solving.
Figure~\ref{fig:cumulative} plots cumulative solves against index for both arms:
the curves climb almost one-for-one over the early items, bend through the
middle, and go flat after the top quartile. The slope --- solves per unit of
index --- decays monotonically, exactly what an increasing-difficulty ordering
predicts. FATE-X's difficulty is therefore expressed in \emph{whether} a problem
is solvable at all, not in \emph{how hard} the solvable ones are to close.
...
\end{axis}
\end{tikzpicture}
\caption{Cumulative solves against problem index. The slope --- solves per unit
index --- falls monotonically and flattens after item~84: FATE-X's increasing
difficulty manifests as a declining \emph{solve rate}, not as costlier proofs
among the items that do get solved (contrast Fig.~\ref{fig:paired}).}
...
On FATE-X, at current budgets, a lifted decomposition scaffolding does not beat a well-tooled flat
agent, despite the scaffolding augmenting proving capacity of small sized LLMs to SOTA levels: Control~II leads Ultra Fleeting 38.8\% to 28.6\% on identical budgets and
